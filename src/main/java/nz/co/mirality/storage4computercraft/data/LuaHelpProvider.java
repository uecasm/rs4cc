...
import nz.co.mirality.storage4computercraft.integration.ae2.MEPeripheral;
import nz.co.mirality.storage4computercraft.integration.refinedstorage.RSPeripheral;
...
public class LuaHelpProvider implements IDataProvider {
    ...
    private static String generateApiArgs(Method method, LuaDoc doc) {
        ...
        RS4CC.LOGGER.warn("Missing @LuaDoc on " + method.getName());
        return "...";
