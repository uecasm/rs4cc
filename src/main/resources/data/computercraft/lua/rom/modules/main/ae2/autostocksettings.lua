...
local handlers = {
    item = {
        ...
        find = function (stack) return ae2.getItem(stack, true, true) end,
        all = function () return ae2.getItems() end,
        findPattern = function (stack) return ae2.getPattern(stack) end,
        craft = function (stack, quantity) return ae2.scheduleTask(stack, quantity) end,
    }, fluid = {
        type = "fluid",
        ...
        find = function (stack) return ae2.getFluid(stack, true, true) end,
        all = function () return ae2.getFluids() end,
        findPattern = function (stack) return {} end,
        craft = function (stack, quantity) return nil, "unsupported" end,
    },
}
